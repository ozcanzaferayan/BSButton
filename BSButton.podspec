#
# Be sure to run `pod lib lint BSButton.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/ozcanzaferayan/BSButton'
  ...
  s.source_files = 'BSButton/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BSButton' => ['BSButton/Assets/*.png']
  # }
